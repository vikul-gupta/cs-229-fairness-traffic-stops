     ...
     for j=1:batch
         for k=j+1:batch
             if (stopOutcome(batchindices(j)) == stopOutcome(batchindices(k))) && ...
                    ((whiteOutcome(batchindices(j)) ~= whiteOutcome(batchindices(k))) || ...
                    (asianOutcome(batchindices(j)) ~= asianOutcome(batchindices(k))) || ...
                    (hispanicOutcome(batchindices(j)) ~= hispanicOutcome(batchindices(k))) || ...
                    (blackOutcome(batchindices(j)) ~= blackOutcome(batchindices(k))))
                counter2 = counter2+1;
